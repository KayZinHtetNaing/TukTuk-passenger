...
function HomeScreen({route}) {
  ...
  return ( 
        ...
        return(
           <SafeAreaView>
            <View style={[{
              ...
              <Text style={{fontSize:20,marginVertical:6,fontWeight:"bold",color:"#111"}} style={{color:theme.color}}>{message.name}</Text>
              <Text style={{fontSize:16,marginVertical:6,color:"#111"}} style={{color:theme.color}}>{message.phoneNumber}</Text>
            </View>
            ...
            <Ionicons name="exit" size={20} color="black" style={[{marginLeft:10},{color:theme.color}]}/>
    ...
    <Drawer.Screen
      ...
      title: "ပင်မစာမျက်နှာ",
          drawerIcon: () => (
            <Ionicons name="home" size={20} color="black" style={{color:theme.color}}/>
          ),
       }}
    />
    ...
    <Drawer.Screen
      ...
      title: "ကိုယ်ရေးအချက်အလက်",
          drawerIcon: () => (
            <FontAwesome name="user-circle-o" size={20} color="black" style={{color:theme.color}}/>
          ),
      }}
    />
    <Drawer.Screen
      ...
      title: "ပြင်ဆင်မှူ",
          drawerIcon: () => (
            <Ionicons name="settings-outline" size={20} color="black" style={{color:theme.color}}/>
          ),
       }}
    />
    <Drawer.Screen
      ...
      options={{  drawerLabel: "သုံးစွဲမှူလမ်းညွှန်",
          ...
          drawerIcon: () => (
            <Ionicons name="compass-outline" size={20} color="black" style={{color:theme.color}}/>
    ...
    />
     <Drawer.Screen
      ...
      options={{  drawerLabel: "အကြုံပြုချက်",
          title: "အကြုံပြုချက်",
          drawerIcon: () => (
            <Ionicons name="send-outline" size={20} color="black" style={{color:theme.color}}/>
    ...
    />
     <Drawer.Screen
      ...
      options={{  drawerLabel: "အကူအညီတောင်းခံမှူ",
          ...
          drawerIcon: () => (
            <AntDesign name="customerservice" size={20} color="black" style={{color:theme.color}}/>
    ...
    />
     <Drawer.Screen
      ...
      options={{  drawerLabel: "အသိအမှတ်ပြုထောက်ခံချက်",
          ...
          drawerIcon: () => (
            <MaterialIcons name="local-police" size={20} color="black" style={{color:theme.color}}/>
