    ...
    return ( 
       ...
       အသုံးပြု၍ကျွန်ုပ်တို့ထံဆက်သွယ်ပါ။
        ...
        <TouchableOpacity style={tw`font-semibold  ml-5`} 
          onPress={() => openURL("tel:+959459496549")}><Text style={tw`text-blue-700 underline-offset-2 `} disabled={canOpenTelephone} style={{color:theme.color}}>+959459496549</Text></TouchableOpacity>
        </View>

        <View style={tw`flex-row p-5 items-center`}>
        <FontAwesome5 name="telegram-plane" size={24} color="black" style={{color:theme.color}}/>
        <TouchableOpacity style={tw`font-semibold  ml-5`} 
          onPress={() => openURL("https://t.me/bibiHsu_28")}><Text style={tw`text-blue-700 underline-offset-2 `} style={{color:theme.color}}>Tuk-Tuk Transportation Service Pyay Channel</Text></TouchableOpacity>
        </View>

        <View style={tw`flex-row p-5 items-center`}>
        <FontAwesome name="facebook-f" size={24} color="black" style={{color:theme.color}}/>
        <TouchableOpacity style={tw`font-semibold  ml-5`} 
          onPress={() => openURL("https://www.facebook.com/profile.php?id=100026578210949")}><Text style={tw`text-blue-700  underline-offset-2 `} style={{color:theme.color}}>Tuk-Tuk Transportation Service Pyay</Text></TouchableOpacity>
        </View>

        <View style={tw`flex-row p-5 items-center`}>
        <Feather name="mail" size={24} color="black" style={{color:theme.color}}/>
        <TouchableOpacity style={tw`font-semibold ml-5`} 
          onPress={() => openURL("mailto:pyaepyae@gmail.com")}><Text style={tw`text-blue-700  underline-offset-2 `} disabled={canOpenMail} style={{color:theme.color}}>TukTukPyat@gmail.com</Text></TouchableOpacity>
        </View>
